...
#pragma warning restore IDE0025
	...
	private IEnumerator Start()
	{
	    ...
	    if (!webCamDevice.HasValue && availableSources != null && availableSources.Length > 0)
	    {
	...
	public void SelectSource(string deviceName)
	{
	    for (int i = 0; i < availableSources.Length; i++)
	    {
		if (availableSources[i].name.GetHashCode() == deviceName.GetHashCode())
		{
