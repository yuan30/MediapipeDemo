...
namespace Mediapipe.Unity.PoseTracking
{
	...
	public event Action<NormalizedLandmarkList> OnPoseLandmarkUpdated; 
	public event Action<LandmarkList> OnPoseWorldLandmarkUpdated; //NEW FOR world
	...
	private void OnPoseLandmarksOutput(object stream, OutputEventArgs<NormalizedLandmarkList> eventArgs)
	{
	    ...
	    OnPoseLandmarkUpdated?.Invoke(eventArgs.value);
	}
